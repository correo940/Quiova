                ...
                {showCreate && (
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-white dark:bg-[#162018] w-full max-w-md rounded-t-2xl sm:rounded-2xl max-h-[85vh] overflow-hidden shadow-2xl pb-[env(safe-area-inset-bottom)] mb-16 sm:mb-0"
