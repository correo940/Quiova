...
export const metadata: Metadata = {
  title: 'QUIOBA Mente — Conocimiento y herramientas para aprender y organizarte mejor',
  description:
    'QUIOBA Mente reúne contenido y herramientas sobre aprendizaje, concentración, organización personal y toma de decisiones.',
};
...
const TOOLS = [
  { name: 'El Campus', emoji: '🎓', desc: 'Un espacio para organizar tu aprendizaje y guardar lo que estudias.' },
  { name: 'Cuadrante', emoji: '📊', desc: 'Herramienta para priorizar tareas y decidir en qué centrarte.' },
  { name: 'Organizador', emoji: '⚡', desc: 'Tu sistema de organización personal con briefings y revisiones.' },
  { name: 'Resumen Diario', emoji: '📋', desc: 'Un resumen de lo más importante de cada día.' },
  { name: 'Debate', emoji: '💬', desc: 'Espacio para estructurar argumentos y analizar ideas desde distintos ángulos.' },
  { name: 'Organizador Vital', emoji: '🗂️', desc: 'Planificación de las áreas más importantes de tu vida.' },
];
  ...
  return (
    <div className="overflow-x-hidden" style={{ backgroundColor: '#ffffff', color: '#0f172a' }}>
      ...
      <section
        ...
        style={{ background: 'radial-gradient(ellipse 70% 60% at 50% 0%, rgba(21,88,168,0.1) 0%, transparent 70%), #eff6ff', minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
      >
        <div className="max-w-3xl mx-auto flex flex-col items-center gap-6">
          <div className="w-16 h-16 rounded-3xl flex items-center justify-center" style={{ backgroundColor: '#ffffff', boxShadow: '0 4px 20px rgba(21,88,168,0.15)' }}>
            <Image src="/images/logo-mente.png" alt="Mente" width={36} height={36} className="object-contain" />
          </div>

          <div>
            <p className="text-sm font-bold tracking-[0.2em] uppercase mb-3" style={{ color: '#2563eb' }}>Los tres pilares</p>
            <h1 className="text-4xl md:text-6xl font-black leading-[1.05] mb-4" style={{ color: '#1558a8' }}>
              QUIOBA Mente
            </h1>
            <p className="text-lg md:text-xl max-w-xl mx-auto leading-relaxed" style={{ color: '#374151' }}>
              Contenido y herramientas para que aprendas mejor, organices tus ideas y tomes
              decisiones más informadas en tu día a día.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-center">
            <Link
              ...
              style={{ backgroundColor: '#1558a8', color: '#ffffff', boxShadow: '0 6px 20px rgba(21,88,168,0.25)' }}
            >
              Explorar contenido <ArrowRight size={16} />
            </Link>
            <Link href="/beta" className="text-sm font-semibold transition-opacity hover:opacity-70" style={{ color: '#1558a8' }}>
              Solicitar acceso →
            </Link>
          </div>
        </div>
      ...
      <section className="py-20 px-6" style={{ backgroundColor: '#ffffff' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            {TOPICS.map((t) => (
              <span
                ...
                style={{ backgroundColor: '#eff6ff', color: '#1558a8', border: '1.5px solid #bfdbfe' }}
              >
                {t}
              </span>
            ))}
          ...
          <p className="mt-8 text-base leading-relaxed" style={{ color: '#64748b' }}>
            QUIOBA no ofrece asesoramiento psicológico ni terapéutico. El contenido disponible
            tiene un carácter divulgativo y está pensado para ayudarte a comprender mejor cómo
            funciona la mente. Ante cualquier dificultad psicológica, consulta a un profesional.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {TOOLS.map((tool) => (
              ...
              >
                ...
                <div>
                  <p className="font-black text-base" style={{ color: '#1558a8' }}>{tool.name}</p>
      ...
      {/* Beta CTA */}
      <section className="py-20 px-6 text-center" style={{ backgroundColor: '#1558a8' }}>
        <div className="max-w-lg mx-auto flex flex-col items-center gap-6">
          ...
          <Link
            ...
            style={{ backgroundColor: '#ffffff', color: '#1558a8' }}
          >
