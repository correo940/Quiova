        ...
        <div className="min-h-screen font-sans">
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
                <div
                    ...
                    style={{
                        background:
                            'radial-gradient(ellipse 80% 60% at 50% 40%, rgba(34,197,94,0.2) 0%, rgba(0,0,0,0) 70%), radial-gradient(ellipse 60% 50% at 80% 70%, rgba(16,185,129,0.15) 0%, transparent 60%)',
                    }}
                />
                ...
                <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                    ...
                    <div className="inline-flex items-center gap-2 bg-green-500/20 text-green-400 text-xs font-semibold px-4 py-2 rounded-full mb-6 border border-green-500/30">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 text-sm text-white/50">
                        <span className="flex items-center gap-1">
                            <Sun size={14} className="text-green-400" /> Rendimiento y Defensa
                        </span>
                        <span>·</span>
                        <span className="flex items-center gap-1">
                            <Moon size={14} className="text-emerald-400" /> Reparación y Limpieza
                        </span>
                    </div>
                </div>
            ...
            <Tabs defaultValue="completo" className="w-full">
                <div className="bg-[#0a0a0a] border-b border-white/10 py-6 sticky top-0 z-50 flex justify-center backdrop-blur-md bg-opacity-80">
                    <TabsList className="bg-white/10 border border-white/5 p-1 rounded-full text-white">
                        <TabsTrigger
                            value="completo"
                            className="rounded-full px-6 py-2 data-[state=active]:bg-green-500 data-[state=active]:text-white"
                        >
                            Artículo Completo
                        </TabsTrigger>
                        <TabsTrigger
                ...
                <TabsContent value="completo" className="m-0 focus-visible:outline-none">
                    ...
                    <section className="bg-white py-24 px-6">
                        <div className="max-w-5xl mx-auto">
                            <FadeIn>
                                <p className="text-green-600 font-semibold text-sm tracking-widest uppercase mb-3">Concepto base</p>
                                <h2 className="text-4xl md:text-5xl font-black text-black mb-6">
                                    ¿Qué son los<br />Ciclos Circadianos?
                                </h2>
                                <p className="text-xl text-zinc-600 max-w-3xl leading-relaxed mb-16">
                    ...
                    <section className="bg-black py-24 px-6">
                        <div className="max-w-4xl mx-auto text-center">
                            <FadeIn>
                                <p className="text-green-400 font-semibold text-sm tracking-widest uppercase mb-6">
                    ...
                    <section className="bg-white py-24 px-6">
                        <div className="max-w-5xl mx-auto">
                            <FadeIn className="max-w-3xl">
                                <p className="text-green-600 font-semibold text-sm tracking-widest uppercase mb-3">La arquitectura</p>
                                <h2 className="text-4xl md:text-5xl font-black text-black mb-4">
                                    No tienes un solo reloj.<br />
                                    <span className="text-green-600">Tienes millones.</span>
                                </h2>
                            ...
                            <div className="grid md:grid-cols-5 gap-6 items-center">
                                ...
                                <FadeIn delay={0.2} className="md:col-span-2 grid grid-cols-2 gap-4">
                                    {[
                                        ...
                                        <div
                                            key={organ.name}
                                            className="bg-zinc-50 border border-zinc-200 rounded-xl p-4 text-center shadow-sm hover:shadow-md transition-shadow"
                                        >
                                            <div className="text-2xl mb-1">{organ.emoji}</div>
                                            <p className="font-semibold text-black text-sm">{organ.name}</p>
                                            <p className="text-zinc-500 text-xs">{organ.sub}</p>
                                        </div>
                                    ))}
                                </FadeIn>
                            </div>
                    ...
                    >
                        <div className="max-w-5xl mx-auto">
                            <FadeIn>
                                <p className="text-green-600 font-semibold text-sm tracking-widest uppercase mb-3">
                                    El interruptor principal
                                </p>
                                <h2 className="text-4xl md:text-5xl font-black text-black mb-6">
                                    La Luz: El Director<br />
                                    <span className="text-green-500">de la Orquesta Biológica</span>
                                </h2>
                                <p className="text-xl text-zinc-700 max-w-2xl mb-12">
                            ...
                            <FadeIn delay={0.1}>
                                <div className="flex items-center justify-center gap-4 md:gap-8 mb-12">
                                    <div className="bg-white rounded-2xl p-6 shadow-md text-center border border-green-100">
                                        <span className="text-5xl">👁️</span>
                                        <p className="text-xs text-zinc-500 mt-2">Retina</p>
                                    </div>
                                    <div className="flex-1 border-t-2 border-dashed border-green-300 max-w-24" />
                                    <div className="text-green-400 text-2xl">→</div>
                                    <div className="flex-1 border-t-2 border-dashed border-emerald-300 max-w-24" />
                                    <div className="bg-white rounded-2xl p-6 shadow-md text-center border border-emerald-100">
                                        <span className="text-5xl">🧠</span>
                                        <p className="text-xs text-zinc-500 mt-2">Reloj Maestro</p>
                                    </div>
                                </div>
                            </FadeIn>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <FadeIn delay={0.2}>
                                    <div className="bg-white rounded-2xl p-8 border border-green-200 shadow-md">
                                        ...
                                        <h3 className="text-xl font-bold text-black mb-2">Luz Natural AM</h3>
                                        <p className="text-green-600 font-semibold mb-2">Efecto: Activación.</p>
                                        <p className="text-zinc-600">Sincroniza el cuerpo para el día.</p>
                                    </div>
                                </FadeIn>
                                <FadeIn delay={0.3}>
                                    <div className="bg-white rounded-2xl p-8 border border-emerald-200 shadow-md">
                                        <div className="text-4xl mb-4">📱</div>
                                        <h3 className="text-xl font-bold text-black mb-2">Luz Artificial / Pantallas PM</h3>
                                        <p className="text-zinc-500 font-semibold mb-2">Efecto: Confusión.</p>
                    ...
                    <section className="bg-black py-24 px-6">
                        <div className="max-w-5xl mx-auto">
                            <FadeIn>
                                <p className="text-green-400 font-semibold text-sm tracking-widest uppercase mb-3">Tu química interna</p>
                            ...
                            <FadeIn delay={0.1}>
                                <div className="relative mb-12">
                                    <div
                                        ...
                                        style={{
                                            background:
                                                'linear-gradient(90deg, #166534 0%, #22c55e 25%, #4ade80 55%, #10b981 75%, #059669 90%, #166534 100%)',
                                        }}
                                    />
                    ...
                    <section className="bg-white py-24 px-6">
                        <div className="max-w-5xl mx-auto">
                            <FadeIn>
                                <p className="text-green-600 font-semibold text-sm tracking-widest uppercase mb-3">La comida importa</p>
                                <h2 className="text-4xl md:text-5xl font-black text-black mb-4">
                            ...
                            <div className="grid md:grid-cols-2 gap-8 mb-10">
                                <FadeIn delay={0.1}>
                                    <div className="flex gap-6 items-start">
                                        <div className="bg-green-100 rounded-2xl p-4 text-center shrink-0">
                                            ...
                                            <p className="text-green-700 font-bold text-sm mt-1">10 PM</p>
                                        </div>
                                        <div>
                                ...
                                <FadeIn delay={0.15}>
                                    <div className="flex gap-6 items-start">
                                        <div className="bg-emerald-100 rounded-2xl p-4 text-center shrink-0">
                                            <div className="text-3xl">🫀</div>
                                            <p className="text-emerald-700 font-bold text-sm mt-1">10 AM</p>
                                        </div>
                                        <div>
                    ...
                    >
                        <div className="max-w-5xl mx-auto">
                            <FadeIn>
                                <p className="text-green-300 font-semibold text-sm tracking-widest uppercase mb-3">Las consecuencias</p>
                                <h2 className="text-4xl md:text-5xl font-black text-white mb-3">
                                    El Precio de la Desincronización
                                </h2>
                                <p className="text-green-300 mb-12 text-lg italic">Un estrés silencioso y constante en el cuerpo.</p>
                            </FadeIn>

                            <div className="grid md:grid-cols-2 gap-6">
                                <FadeIn delay={0.1}>
                                    <div className="bg-white/5 border border-green-500/30 rounded-2xl p-8">
                                        ...
                                        <ul className="space-y-3">
                                            {[
                                                ...
                                                <li key={item} className="flex items-start gap-3 text-green-200/80">
                    ...
                    <section className="bg-white py-24 px-6">
                        <div className="max-w-5xl mx-auto">
                            <FadeIn>
                                ...
                                <p className="text-xl text-zinc-600 mb-16">
                                ...
                                <div>
                                    <FadeIn>
                                        <div className="flex items-center gap-3 mb-8">
                                            ...
                                            <h3 className="text-2xl font-black text-black">El Día</h3>
                                        </div>
                                    </FadeIn>
                                ...
                                <div>
                                    <FadeIn>
                                        <div className="flex items-center gap-3 mb-8">
                                            ...
                                            <h3 className="text-2xl font-black text-black">La Noche</h3>
                                        </div>
                                    </FadeIn>
                                    <div className="space-y-6">
                                        {[
                                            ...
                                            <FadeIn key={step.n} delay={i * 0.1}>
                                                <div className="flex gap-5">
                                                    <div className="w-12 h-12 rounded-xl bg-emerald-100 flex items-center justify-center text-emerald-700 font-black text-xl shrink-0">
                                                        {step.n}
                                                    </div>
                                                    <div>
                                                        <h4 className="font-bold text-black mb-1">{step.title}</h4>
                        ...
                        <div className="max-w-4xl mx-auto text-center">
                            <FadeIn>
                                <h2 className="text-4xl md:text-5xl font-black text-black mb-6">
                                    ...
                                    <span className="text-green-600">es tu Estilo de Vida.</span>
                                </h2>
                            </FadeIn>
                            <FadeIn delay={0.1}>
                    ...
                    {/* ── CTA Final ── */}
                    <section className="relative py-32 px-6 overflow-hidden bg-gradient-to-br from-black via-zinc-900 to-black">
                        <div
                        ...
                        <div className="relative z-10 max-w-3xl mx-auto text-center">
                            ...
                            <FadeIn delay={0.4}>
                                <Link
                                    href="/articles"
                                    className="inline-flex items-center gap-2 bg-green-500 text-white font-bold px-8 py-4 rounded-2xl hover:bg-green-400 transition-all"
                                >
                    ...
                    <div className="max-w-6xl mx-auto py-24 px-6">
                        <div className="mb-12">
                            <h2 className="text-3xl md:text-5xl font-black text-black mb-4">
                                Resumen de <span className="text-green-600">Ciclos Circadianos</span> e Hábitos Saludables
                            </h2>
                                ...
                                <table className="w-full text-left border-collapse min-w-[900px]">
                                    <thead>
                                        <tr className="border-b border-zinc-200 bg-zinc-50 text-sm uppercase tracking-wider">
                                            <th className="p-6 font-bold text-zinc-700 border-l-4 border-green-500 w-1/6">Factor Biológico o Hábito</th>
                                    ...
                                    <tbody>
                                        <tr className="border-b border-zinc-100 hover:bg-zinc-50 transition-colors">
                                            ...
                                            <td className="p-6 align-top text-zinc-600 leading-relaxed">
                                                <span className="text-green-600 font-semibold">Cortisol</span> (sube por la mañana), <span className="text-indigo-600 font-semibold">Melatonina</span> (se inhibe con luz)
                                            </td>
                                            <td className="p-6 align-top text-zinc-600 leading-relaxed">
