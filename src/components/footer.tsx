...
const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    text: "El control de los gastos hormiga me abrió los ojos. He ahorrado más de 120€ al mes casi sin darme cuenta. Una app imprescindible.",
    rating: 5,
    category: "finanzas",
    initials: "JL",
  ...
  },
  {
    ...
    text: "Recomiendo las herramientas de Quioba Mente a mis pacientes. El enfoque integral es la clave para un autocuidado diario sostenible.",
    rating: 5,
    category: "mente",
    initials: "CD",
  ...
  },
  {
    ...
    text: "Como freelance, gestionar salud y finanzas en un solo lugar me ahorra tiempo y dolores de cabeza. La interfaz es intuitiva y preciosa.",
    rating: 5,
    category: "general",
    initials: "RS",
  ...
  },
  {
    ...
    text: "Los recordatorios de hidratación y las pausas activas me ayudan a no estar tan cansada al final de mi jornada de teletrabajo.",
    rating: 5,
    category: "cuerpo",
    initials: "MF",
  ...
  {
    name: "Pablo Castro",
    role: "Ingeniero de Caminos",
    text: "Pensaba que la salud mental era secundaria, pero el diario guiado y las herramientas de enfoque me han ayudado a lograr mis metas personales.",
    rating: 5,
    category: "mente",
    initials: "PC",
